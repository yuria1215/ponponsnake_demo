                    ...
                    <div className="button" id="Sort">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14.161" height="13.126" viewBox="0 0 14.161 13.126">
                            <g id="arrows-vertical" transform="translate(-3.021 -4.146)">
                                <path id="Path_4468" data-name="Path 4468" d="M24.61,13.09l-1.863,1.863V4.5H21.712V14.953L19.849,13.09l-.724.724,3.1,3.1,3.1-3.1Z" transform="translate(-8.505 0)" fill="#c5cbfe" stroke="#c5cbfe" stroke-width="0.5" />
                                <path id="Path_4469" data-name="Path 4469" d="M6.48,4.5l-3.1,3.1.724.724L5.962,6.466V16.919H7V6.466L8.86,8.329,9.585,7.6Z" transform="translate(0 0)" fill="#c5cbfe" stroke="#c5cbfe" stroke-width="0.5" />
                            </g>
                        </svg>
